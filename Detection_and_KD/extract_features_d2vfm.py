...
def main():
    ...
    parser.add_argument('--wsi_root', type=str, default='/home1/xxx/TCT_smear_xxx')
    parser.add_argument('--output_dir', type=str, default='/home1/xxx/gc-all-features/distill')
    ...
    # model options
    parser.add_argument('--ckp_dir', type=str, default='/home/xxx/xxx/Deformable-DETR-main/exps/tct_d2vfm/biomedclip_MSE_gmpa_ep4')
