...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', default='/home1/wsi/gc-all-features/distill/plip_MAE_gmpa_ep6', type=str, help='Dataset root path')
    ...
    parser.add_argument('--baseline', default='attn', type=str, help='Baselin model [attn,selfattn,dsmil]')
    ...
    parser.add_argument('--ckp_path', type=str, default='/home/xxx/projects/D2VFM-xxx/MIL/output-model/mil-d2vfm/plip_MAE_gmpa_ep6-mhim(abmil)-gc-trainval-308002-2026', help='Checkpoint path')
