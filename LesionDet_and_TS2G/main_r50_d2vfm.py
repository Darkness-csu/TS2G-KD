...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--distill_dataset', default='biomedclip', choices=['biomedclip','clip','plip','gigapath'])
    parser.add_argument('--data_root', default='/home/commonfile/wsi/gc-filter/filter-features', type=str) #/home1/ligaojie/TCT_patch_hjl
    ...
    parser.add_argument('--adapter_type', default=['mpa'], type=str, choices=['p', 'm', 'mp', 'mpa'])
    return parser
